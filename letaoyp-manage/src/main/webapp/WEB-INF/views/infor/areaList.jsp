...
<div class="row-fluid sortable ui-sortable">	
	<div class="box span12">
		<div class="box-header well" data-original-title="">
			<form action="${ctx}/infor/area" method="post">
			<h2>
				<span class="ajax-link btn btn-primary" action="${ctx}/infor/area/create"><i class="icon-plus"></i> Area</span>
					...
					<td class="center ">
						<shiro:hasPermission name="area:edit">
							<a class="btn btn-info ajax-link" style="padding: 0;"
								action="${ctx}/infor/area/update/${item.id}" title="编辑">
								<i class="icon-edit icon-white"></i> </a>
							<a class="btn btn-danger ajax-link" style="padding: 0;"
								action="${ctx}/infor/area/delete/${item.id}" title="删除">
	   ...
	   <tags:pagination page="${page}" paginationSize="5" action="${ctx}/infor/area" />
	</div>
	</div><!--/span-->
</div>
