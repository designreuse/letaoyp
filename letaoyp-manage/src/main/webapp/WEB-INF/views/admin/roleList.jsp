...
<div class="row-fluid sortable ui-sortable">	
	<div class="box span12">
		<div class="box-header well" data-original-title="">
			<h2>
				<a class="ajax-link" href="#" action="${ctx}/admin/role/create"><i class="icon-plus"></i> 角色表</a>&nbsp;&nbsp;&nbsp;&nbsp;
					...
					<td class="center ">
						<shiro:hasPermission name="user:edit">
							<a class="btn btn-info" style="padding: 0;"
								href="${ctx}/admin/role/update/${item.id}" title="编辑">
								<i class="icon-edit icon-white"></i> </a>
							<a class="btn btn-danger" style="padding: 0;"
								href="${ctx}/admin/role/delete/${item.id}" title="删除">
