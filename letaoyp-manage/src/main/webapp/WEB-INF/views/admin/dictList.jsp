...
<div class="row-fluid sortable ui-sortable">	
	<div class="box span12">
		<div class="box-header well" data-original-title="">
			<form action="${ctx}/admin/dict" method="post">
			<h2>
				<span class="ajax-link btn btn-primary" action="${ctx}/admin/dict/create"><i class="icon-plus"></i> 字典表</span>
					...
					<td class="center ">
						<shiro:hasPermission name="dict:edit">
							<a class="btn btn-info ajax-link" style="padding: 0;"
								action="${ctx}/admin/dict/update/${item.id}" title="编辑">
								<i class="icon-edit icon-white"></i> </a>
							<a class="btn btn-danger ajax-link" style="padding: 0;"
								action="${ctx}/admin/dict/delete/${item.id}" title="删除">
