      ...
      <input type="hidden" id="id" name="id" value="${member.id}"/>
	    ...
	    <div class="form-group">
	      ...
	      <div class="col-sm-6">
		          ...
		          type="text" value="<fmt:formatDate value='${member.created}' pattern='yyyy-MM-dd HH:mm:ss'/>" readonly="readonly">
	      </div>
	    </div>
	    <div class="form-group">
	      ...
	      <div class="col-sm-6">
		          ...
		          type="text" value="<fmt:formatDate value='${member.modified}' pattern='yyyy-MM-dd HH:mm:ss'/>" readonly="readonly">
	      </div>
	    </div>
