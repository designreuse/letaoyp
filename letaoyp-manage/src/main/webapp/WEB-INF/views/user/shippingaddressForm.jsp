      ...
      <input type="hidden" id="id" name="id" value="${shippingAddress.id}"/>
	    ...
	    <div class="form-group">
	      ...
	      <div class="col-sm-6">
		          ...
		          type="text" value="<fmt:formatDate value='${shippingAddress.created}' pattern='yyyy-MM-dd HH:mm:ss'/>" disabled>
	      </div>
	    </div>
	    <div class="form-group">
	      ...
	      <div class="col-sm-6">
		          ...
		          type="text" value="<fmt:formatDate value='${shippingAddress.modified}' pattern='yyyy-MM-dd HH:mm:ss'/>" disabled>
	      </div>
	    </div>
