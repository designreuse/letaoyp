      ...
      <input type="hidden" id="id" name="id" value="${cartItem.id}"/>
	    ...
	    <div class="form-group">
	      ...
	      <div class="col-sm-6">
		          ...
		          type="text" value="<fmt:formatDate value='${cartItem.created}' pattern='yyyy-MM-dd HH:mm:ss'/>" readonly="readonly">
	      </div>
	    </div>
	    <div class="form-group">
	      ...
	      <div class="col-sm-6">
		          ...
		          type="text" value="<fmt:formatDate value='${cartItem.modified}' pattern='yyyy-MM-dd HH:mm:ss'/>" readonly="readonly">
	      </div>
	    </div>
