...
public class BrandController extends BasicController {
	...
	@ResponseBody
	public AjaxResult update(@Valid @ModelAttribute("brand") Brand brand) {
	...
	public AjaxResult settings(@RequestParam("ids")Long[] ids, @RequestParam("active")boolean active) {
		...
		brandService.updateActiveByIds(active, ids);
		return AjaxResult.succeed();
	}
