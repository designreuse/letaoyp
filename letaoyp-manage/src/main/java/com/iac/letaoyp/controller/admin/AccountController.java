...
public class AccountController extends BasicController {
	...
	@ResponseBody
	public AjaxResult update(@Valid @ModelAttribute("account") Account account) {
	...
	public String checkLoginName(@RequestParam("loginName")String loginName) {
		return String.valueOf(accountService.findByLoginName(loginName) == null);
	}
	...
	public AjaxResult settings(@RequestParam("ids")Long[] ids, @RequestParam("active")boolean active) {
		...
		accountService.updateActiveByIds(active, ids);
		return AjaxResult.succeed();
	}
