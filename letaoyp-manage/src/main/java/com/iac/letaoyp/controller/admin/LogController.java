...
import com.iac.letaoyp.service.admin.LogService;
...
public class LogController extends BasicController {
	...
	public String list(@RequestParam(value = "page", defaultValue = "1") int pageNumber,
		...
		Page<Log> page = logService.findPage(searchParams, pageNumber, pageSize, sortType);
	...
	@ResponseBody
	public AjaxResult update(@Valid @ModelAttribute("log") Log log) {
		logService.save(log);
	...
	public AjaxResult settings(@RequestParam("ids")Long[] ids, @RequestParam("active")boolean active) {
		...
		logService.updateActiveByIds(active, ids);
		return AjaxResult.succeed();
	}
	 ...
	 */
	@ModelAttribute
	public void getLog(@RequestParam(value = "id", defaultValue = "-1") java.lang.Long id, Model model) {
		if (id != -1) {
