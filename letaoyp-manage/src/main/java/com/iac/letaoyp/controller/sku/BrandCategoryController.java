...
public class BrandCategoryController extends BasicController {
	...
	public String update(@Valid @ModelAttribute("brandCategory") BrandCategory brandCategory, 
		...
		return "redirect:/sku/brandcategory";
	}
	...
	public String batchDelete(ModelMap model,@RequestParam("items") java.lang.Long[] items,
		...
		for(int i = 0; i < items.length; i++) {
			brandCategoryService.delete(items[i]);
		}
		redirectAttributes.addFlashAttribute("message", "删除成功");
		return "redirect:/sku/brandcategory";
	}
