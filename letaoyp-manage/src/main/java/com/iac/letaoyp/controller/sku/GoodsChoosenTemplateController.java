...
import com.iac.letaoyp.service.sku.GoodsChoosenTemplateService;


@Controller
@RequestMapping("sku/goodschoosentemplate")
public class GoodsChoosenTemplateController extends BasicController {
	...
	public String list(@RequestParam(value = "page", defaultValue = "1") int pageNumber,
		...
		return "sku/goodschoosentemplateList";
	}
	
	@RequestMapping(value="/create", method = RequestMethod.GET)
	public String createForm(ModelMap model) {
		return "sku/goodschoosentemplateForm";
	}
	...
	@ResponseBody
	public AjaxResult update(@Valid @ModelAttribute("goodsChoosenTemplate") GoodsChoosenTemplate goodsChoosenTemplate) {
	...
	public AjaxResult batchDelete(@RequestParam("ids") java.lang.Long[] ids) {
		...
		goodsChoosenTemplateService.delete(ids);
		return AjaxResult.succeed();
	}
	...
	public AjaxResult settings(@RequestParam("ids")Long[] ids, @RequestParam("active")boolean active) {
		...
		goodsChoosenTemplateService.updateActiveByIds(active, ids);
		return AjaxResult.succeed();
	}
