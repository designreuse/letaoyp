...
@Controller
@RequestMapping("sku/goodschoosen")
public class GoodsChoosenController extends BasicController {
	...
	public String list(@RequestParam(value = "page", defaultValue = "1") int pageNumber,
		...
		return "sku/goodschoosenList";
	}
	
	@RequestMapping(value="/create", method = RequestMethod.GET)
	public String createForm(ModelMap model) {
		return "sku/goodschoosenForm";
	}
	...
	@ResponseBody
	public AjaxResult update(@Valid @ModelAttribute("goodsChoosen") GoodsChoosen goodsChoosen) {
	...
	public AjaxResult batchDelete(@RequestParam("ids") java.lang.Long[] ids) {
		...
		goodsChoosenService.delete(ids);
		return AjaxResult.succeed();
	}
