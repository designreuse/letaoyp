...
import com.iac.letaoyp.service.admin.DictService;
...
public class DictController extends BasicController {
	...
	public String list(@RequestParam(value = "page", defaultValue = "1") int pageNumber,
		...
		Page<Dict> page = dictService.findPage(searchParams, pageNumber, pageSize, sortType);
	...
	@ResponseBody
	public AjaxResult update(@Valid @ModelAttribute("dict") Dict dict) {
	...
	public AjaxResult settings(@RequestParam("ids")Long[] ids, @RequestParam("active")boolean active) {
		...
		dictService.updateActiveByIds(active, ids);
		return AjaxResult.succeed();
	}
	 ...
	 */
	@ModelAttribute
	public void getDict(@RequestParam(value = "id", defaultValue = "-1") java.lang.Long id, Model model) {
		if (id != -1) {
